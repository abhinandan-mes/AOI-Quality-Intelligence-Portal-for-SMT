...
export const translations: Translations = {
  ...
  // Menu
  'menu.spiDashboard': { en: 'SPI Dashboard', zh: 'SPI 仪表板' },
  'menu.postAoiDashboard': { en: 'Post AOI Dashboard', zh: 'Post AOI 仪表板' },
  ...
  'lines.preAoiConfigs': { en: 'Pre AOI Configurations', zh: 'Pre AOI 配置' },
  'lines.preAoiPaths': { en: 'Lines with Pre AOI watch paths', zh: '带有 Pre AOI 监控路径的产线' },
  ...
  'lines.colPreAoiPath': { en: 'Pre AOI Watch Path', zh: 'Pre AOI 监控路径' },
  ...
  'lines.labelPreAoiPath': { en: 'Pre AOI Watch Path', zh: 'Pre AOI 监控路径' },
