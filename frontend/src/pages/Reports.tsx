      ...
      <div className="premium-toolbar animate-slide-up" style={{ marginBottom: '24px' }}>
        <div className="toolbar-filters">
          <div className="filter-group date-group">
            <span style={{ fontSize: '14px', fontWeight: 600, color: '#334155' }}>Filter Range:</span>
      ...
      <div id="report-dashboard">
        <div className="dashboard-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
          ...
          <div className="premium-table-card animate-slide-up" style={{ animationDelay: '0.1s', padding: '24px' }}>
            <h3 style={{ marginTop: 0, marginBottom: '24px', color: '#0f172a', fontSize: '1.2rem', fontWeight: 700 }}>Top 10 Defects (Pareto)</h3>
            <div style={{ width: '100%', height: 350 }}>
              {loading ? (
                ...
                <div style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#94a3b8' }}>No defect data available</div>
              )}
            </div>
          </div>
          ...
          <div className="premium-table-card animate-slide-up" style={{ animationDelay: '0.2s', padding: '24px' }}>
            <h3 style={{ marginTop: 0, marginBottom: '24px', color: '#0f172a', fontSize: '1.2rem', fontWeight: 700 }}>Production Yield Trend</h3>
            <div style={{ width: '100%', height: 350 }}>
              {loading ? (
                <div style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>Loading chart...</div>
              ) : yieldData.length > 0 ? (
                ...
                <div style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#94a3b8' }}>No yield data available</div>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="premium-table-card animate-slide-up" style={{ animationDelay: '0.3s', marginTop: '24px' }}>
          <div style={{ padding: '24px', paddingBottom: '0' }}>
            <h3 style={{ marginTop: 0, marginBottom: '16px', color: '#0f172a', fontSize: '1.2rem', fontWeight: 700 }}>Yield Summary Table</h3>
          </div>
            ...
            <table className="report-table premium-table">
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={5} style={{ textAlign: 'center', color: '#94a3b8' }}>No yield data to display</td>
                  </tr>
                ) : (
