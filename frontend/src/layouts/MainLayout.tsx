...
export default function MainLayout({ onLogout }: { onLogout?: () => void }) {
  ...
  const handleLogout = async () => {
    try {
      const activeUser = localStorage.getItem('user') ? JSON.parse(localStorage.getItem('user')!) : { username: 'abhinandan' };
      ...
      <div className="layout-body">
        ...
        <aside className="layout-sidebar">
          <div className="nav-links-container">
            <NavLink to="/spi-dashboard" style={({ isActive }) => navItemStyle(isActive)}>
